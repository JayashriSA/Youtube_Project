...
1.Open the test.py file in the project directory.
...
1.Launch the Streamlit app: streamlit run test.py

2.Run the test.py script, make sure you have main and sql files in the same folder.
